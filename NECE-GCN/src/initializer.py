...
class Initializer():
    ...
    def init_dataloader(self):
        ...
        self.feeders, self.data_shape, self.num_class, self.A, self.parts,self.A_e,self.A_T,self.A_angle,self.angle_T = dataset.create(
    ...
    def init_model(self):
        kwargs = {
            ...
            'parts': self.parts,
            'A_e': torch.Tensor(self.A_e),
            'A_T': torch.Tensor(self.A_T),
            'A_a':torch.Tensor(self.A_angle),
            'a_T': torch.Tensor(self.angle_T)
        }
